...
<body>
  ...
  <hr>
    ...
    if (isset($_POST['submit'])) {
		...
		$sql = "UPDATE Teacher SET TeacherName = '$TeacherName', Teach_Address = '$Teach_Address', Teach_MedInfo = '$Teach_MedInfo', Teach_Phone = '$Teach_Phone', Salary = '$Salary', Backround = '$Backround' WHERE TeacherID = '$TeacherID'";
